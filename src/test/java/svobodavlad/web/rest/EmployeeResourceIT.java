...
import svobodavlad.repository.EmployeeRepository;
import svobodavlad.service.EmployeeService;
import svobodavlad.service.dto.EmployeeDTO;
import svobodavlad.service.mapper.EmployeeMapper;
...
class EmployeeResourceIT {
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getHeight()).isEqualByComparingTo(DEFAULT_HEIGHT);
    ...
    void putNewEmployee() throws Exception {
        ...
        assertThat(testEmployee.getHeight()).isEqualByComparingTo(UPDATED_HEIGHT);
